...
export class GeographyService extends GenericService {
	constructor(public http: HttpClient, private companyService: CompanyService, private campaignService: CampaignService) {
		super('geography', http);
	}

	getGeography(type: string, parent = null, campaign: string = '',geography_id = null) {
		let str = '';
		let qp = '';
