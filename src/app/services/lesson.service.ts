...
export class LessonService extends GenericService {
	...
	getLesson(course_id,campaign_id, lesson_id) {
		return this.http.get(`${this.apiUrl}lesson/getLessonDropDown?campaign_id=` + campaign_id+"&course_id="+course_id+"&lesson_id="+lesson_id);
	}
