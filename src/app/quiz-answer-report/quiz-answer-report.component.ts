...
@Component({
  ...
  templateUrl: './quiz-answer-report.component.html',
  styleUrls: ['./quiz-answer-report.component.css']
})

export class QuizAnswerReportComponent implements OnInit, AfterViewInit {
  ...
  loadReportData() {
	...
	loadData(Obj) {
		...
		return this.reportsService.getQuizAnswerReport(Obj);
  }
  ...
  pageChange(pageNumber) {
    this.router.navigate([], {
      ...
      queryParams: { page: pageNumber, campaign_id: this.campaign_id ,quiz_id:this.quiz_id}
    });
  }
